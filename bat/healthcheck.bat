...
set "ESRUNID="
for /f "usebackq delims=" %%i in (`powershell -NoProfile -ExecutionPolicy Bypass -File "1_Skrypty_Python\monitor.ps1" -Begin "healthcheck"`) do set "ESRUNID=%%i"

powershell -NoProfile -ExecutionPolicy Bypass -File "1_Skrypty_Python\healthcheck.ps1" %*
set "ESRC=%ERRORLEVEL%"
