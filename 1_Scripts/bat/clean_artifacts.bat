...
echo ============================================
echo   files   - generated PDFs/XLSX in 3_Test_Documents
...
set "ESRUNID="
for /f "usebackq delims=" %%i in (`powershell -NoProfile -ExecutionPolicy Bypass -File "1_Scripts\ps\monitor.ps1" -Begin "clean"`) do set "ESRUNID=%%i"
cd 1_Scripts\py
