...
3. **Attach** one of the test documents from `3_Test_Documents/`:
...
- Test documents: `../3_Test_Documents/*_Report_*.xlsx` and `*.pdf`
- Database: `../2_Database/energosmart_history.db`
